...
import { ComposerAdvancedSettings } from './ComposerAdvancedSettings';
  ...
  return (
    <div className="flex items-center justify-between px-2 pb-1">
      ...
      <div className="flex items-center gap-2">
        ...
        >
          <option value="read-only" className="bg-surface text-on-surface">Chỉ xem</option>
          <option value="workspace-write" className="bg-surface text-on-surface">Chỉnh sửa trong dự án</option>
          <option value="danger-full-access" className="bg-surface text-on-surface">Toàn quyền dự án</option>
        </select>
        ...
        {!!models.length && (
          <>
            ...
            <ComposerAdvancedSettings models={models} activeModelId={settings.activeModelId} fallbackModelId={settings.fallbackModelId} onFallbackModelChange={props.onFallbackModelChange} />
          </>
        )}
      </div>
    </div>
