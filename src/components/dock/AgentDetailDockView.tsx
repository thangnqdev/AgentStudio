...
export function AgentDetailDockView(props: { agentId?: string; control: AgentControlViewModel }) {
  ...
  if (!participant) {
    return <div className="flex flex-1 flex-col items-center justify-center px-8 text-center text-[#888]"><span className="material-symbols-outlined text-[28px]">person_off</span><p className="mt-3 text-[12px]">Agent này không còn trong tác vụ hiện tại.</p></div>;
  }
  return (
